...
protected:
	...
	// *********** Free standing animation ************
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = Animations)
	class UPaperFlipbook* freeAnimation;

	//  *********** Climing animation ************
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category=Animations)
	class UPaperFlipbook* ClimbingAnimation;

	// *********** Waiting while climing animation ************
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = Animations)
	class UPaperFlipbook* ClimbingFreeAnimation;
